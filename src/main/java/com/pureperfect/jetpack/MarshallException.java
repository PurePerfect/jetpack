...
/**
 * Thrown when there is an error while marshalling an object to an output
 * stream.
 * 
...
public class MarshallException extends RuntimeException
{
	 ...
	 *            the error message
	 */
	public MarshallException(final String message)
	{
		super(message);
	}
	 ...
	 */
	public MarshallException(final String message, final Throwable cause)
	{
		super(message, cause);
	}
